...
/* init */
{
    ...
    sif_reg_write(XPAR_DBE_ADC_SINGLE_SMASEL_BASEADDR, 0);
...
*/	//end new stuff
    ...
    sif_reg_write(XPAR_DBE_ADC_SINGLE_OUTPUT_SEL_BASEADDR, 3);
...
/* params  = "<source>" */
{
    ...
    sif_reg_write(XPAR_DBE_ADC_SINGLE_OUTPUT_SEL_BASEADDR, muxsel);
}
