...
% Version strings for the different designs
...
\rwreg{xaui\_rst}  Resets the XAUI cores.

\vspace{2\parskip}
\begin{bytefield}{32}
  \bitheader[b]{0-31} \\
  \bitbox{29}{\color[gray]{0.75}\rule{\width}{\height}} &
  \bitbox{1}{\rotatebox{90}{\scriptsize ho1}}
  \bitbox{1}{\rotatebox{90}{\scriptsize ho0}}
  \bitbox{1}{\rotatebox{90}{\scriptsize rst}}
\end{bytefield}
...
\filbreak
\roregn{xaui0/valid}
\roregs{xaui1/valid} This register contains the 32 most recent values of the
...
\begin{bytefield}{32}
  \bitheader[b]{0-31} \\
  \bitbox{32}{32 values of XAUI \texttt{valid} bit}
\end{bytefield}
...
\roregn{xaui0/empty}
\roregs{xaui1/empty} This register contains the 32 most recent values of the
XAUI block's \verb|empty| status bit.

\vspace{2\parskip}
\begin{bytefield}{32}
  \bitheader[b]{0-31} \\
  \bitbox{32}{32 values of XAUI \texttt{empty} bit}
\end{bytefield}
